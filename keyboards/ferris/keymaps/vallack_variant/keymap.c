...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //------------------------------------------------------------------------------       ----------------------------------------------------------------------------
      MT(MOD_LCTL,KC_A),    KC_S,    MT(MOD_LALT,KC_D),    MT(MOD_LGUI,KC_F),    KC_G,  	                            KC_H, KC_J,   KC_K,  KC_L,  KC_SCLN,
  //------------------------------------------------------------------------------       ----------------------------------------------------------------------------
      KC_Z,   KC_X,  KC_C,   KC_V,  KC_B,     						                                    KC_N,   KC_M,   KC_COMMA,   TD(DANCE_1),   KC_SLSH,
  //------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
		    					                                 KC_BSPC,  KC_LSFT,      KC_SPACE, TO(1)
  //------------------------------------------------------------------------------       ----------------------------------------------------------------------------------
  ),
